...
2.  **Virtual Reserves (L):** This represents the "Mathematical Depth." To keep the price curve flat and stable within your range, the AMM calculates swaps _as if_ it had the depth of a much larger pool (e.g., the $1,000,000 equivalent).
